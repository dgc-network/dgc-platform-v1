        ...
        match product_type {
            ...
            protos::product_state::Product_ProductType::UNSET_TYPE => {
                Err(ProtoConversionError::InvalidTypeError(
                    "Cannot convert Product_ProductType with type UNSET_TYPE".to_string(),
                ))
            }
        }
    }
...
impl IntoProto<protos::product_state::Product_ProductType> for ProductType {}
impl IntoNative<ProductType> for protos::product_state::Product_ProductType {}
